<?php
$eid = protect($_GET['id']);
$query = $db->query("SELECT * FROM bit_exchanges WHERE uid='$_SESSION[bit_uid]' and exchange_id='$eid'");
			...
			<div id="bit_exchange_box">
					...
					<table class="table table-striped">
						<tbody>
							<tr>
								<td colspan="2">
									<h3 class="text-center">
										<?php echo $lang['data_about_transfer']; ?>
									</h3>
								</td>
							</tr>
							<?php
							...
							?>
							<tr>
								<td><span class="pull-left"><?php echo $lang['your_email']; ?></span></td>
